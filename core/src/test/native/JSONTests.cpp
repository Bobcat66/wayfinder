...
= R"({
    ...
    EXPECT_EQ("MISSING_PROPERTY at /backend",badRes0.what());
    ...
    EXPECT_EQ("MISSING_PROPERTY at /format/frameFormat/height",badRes1.what());
    ...
    EXPECT_EQ("BAD_TYPE at /calibrations/0/matrix/fx",badRes2.what());
    ...
    EXPECT_EQ("SCHEMA_VIOLATION at /calibrations/0/distortion",badRes3.what());
    ...
    EXPECT_EQ("BAD_TYPE at /calibrations/0/distortion/3",badRes4.what());
    ...
    EXPECT_EQ("SCHEMA_VIOLATION at /backend",badRes5.what());
    ...
    EXPECT_EQ("SCHEMA_VIOLATION at /controlAliases/SHARPNES",badRes6.what());
